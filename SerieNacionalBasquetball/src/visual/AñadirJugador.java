			...
			btnAgregarJugador.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if(!nombreJugador.equalsIgnoreCase("") && !posicion.equalsIgnoreCase("<Seleccione>") && !checkNumero(numero) && ready) {
						...
						Baloncesto.getInstance().getMisEquipos().get(index).getJugadores().add(aux);
				...
				private boolean checkNumero(int numero) {
					...
					for (Jugador player : Baloncesto.getInstance().getMisEquipos().get(index).getJugadores()) {
